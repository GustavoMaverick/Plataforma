...
class Config:
    ...
    API_KEY = "AIzaSyB7AAnpc7XvEgLZ5pcKP-foFBnDonQo5dA"
    API_URL = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key={API_KEY}"
    
    # URLs de checkout/páginas
    VIP_LINK = "https://exemplo.com/vip"
    CHECKOUT_START = "https://pay.risepay.com.br/Pay/c6463031a3954046b4ff4268819ab579"
    ...
    AUDIO_FILE = "https://github.com/GustavoMaverick/Plataforma/raw/refs/heads/main/assets/assets_audio_paloma_audio%20(1).mp3"
    AUDIO_DURATION = 7
    
    # Imagens
    IMG_PROFILE = "https://i.ibb.co/ks5CNrDn/IMG-9256.jpg"
    IMG_GALLERY = [
        "https://i.ibb.co/LD8TQBwb/Paloma-Icone.jpg",
